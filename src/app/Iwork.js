...
function Iwork() {
  return (
    ...
    <div class="container">
      <img decoding="async" src="imagr/work-steps.png" alt="" class="image" />
      <div class="info">
        <div class="box">
          <img src="imagr/work-steps-1.png" alt=""/>
          <div class="text">
        ...
        <div class="box">
          <img src="imagr/work-steps-2.png" alt=""/>
          <div class="text">
            <h3>Architecture</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim nesciunt obcaecati quisquam quis laborum
              recusandae debitis vel</p>
        ...
        <div class="box">
          <img src="imagr/work-steps-3.png" alt=""/>
          <div class="text">
            <h3>Developement</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim nesciunt obcaecati quisquam quis laborum
              recusandae debitis vel</p>
